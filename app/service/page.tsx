...
const services = [
  {
    ...
    en: "Advisory",
    ja: "アドバイザリー",
    lead: "プロジェクトの目的に合わせて、制作業務がスムーズに進むよう伴走するフェーズ。",
    description:
      "週単位・月単位の継続契約から、スポットでのミーティング設定まで。\nプロジェクトの目的に合わせて、制作業務がスムーズに進むよう伴走します。\n必要に応じたチームを編成し、クライアントと同じ目線で一緒に考え、一緒に作り上げていきます。",
    scope: [
      "リブランディングにおける戦略・方向性の相談",
      "パートナー企業・制作会社へのディレクション",
      "制作物の監修・クリエイティブディレクション",
      "既存運用チームへのディレクション支援",
      "社内制作体制の構築サポート",
      "その他、各種ご相談",
    ],
